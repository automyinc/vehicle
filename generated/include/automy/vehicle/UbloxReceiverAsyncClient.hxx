...
#ifndef INCLUDE_automy_vehicle_UbloxReceiver_ASYNC_CLIENT_HXX_
#define INCLUDE_automy_vehicle_UbloxReceiver_ASYNC_CLIENT_HXX_
...
class UbloxReceiverAsyncClient : public vnx::AsyncClient {
public:
	UbloxReceiverAsyncClient(const std::string& service_name);
	
	UbloxReceiverAsyncClient(vnx::Hash64 service_addr);
...
#endif // INCLUDE_automy_vehicle_UbloxReceiver_ASYNC_CLIENT_HXX_
