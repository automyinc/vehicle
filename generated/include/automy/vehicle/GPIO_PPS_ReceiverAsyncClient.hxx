...
#ifndef INCLUDE_automy_vehicle_GPIO_PPS_Receiver_ASYNC_CLIENT_HXX_
#define INCLUDE_automy_vehicle_GPIO_PPS_Receiver_ASYNC_CLIENT_HXX_
...
class GPIO_PPS_ReceiverAsyncClient : public vnx::AsyncClient {
public:
	GPIO_PPS_ReceiverAsyncClient(const std::string& service_name);
	
	GPIO_PPS_ReceiverAsyncClient(vnx::Hash64 service_addr);
...
#endif // INCLUDE_automy_vehicle_GPIO_PPS_Receiver_ASYNC_CLIENT_HXX_
