...
#ifndef INCLUDE_vehicle_UbloxReceiverBase_HXX_
#define INCLUDE_vehicle_UbloxReceiverBase_HXX_
...
protected:
	virtual void handle(std::shared_ptr<const ::vehicle::PPS_Signal> _value, std::shared_ptr<const ::vnx::Sample> _sample) { handle(_value); }
	virtual void handle(std::shared_ptr<const ::vehicle::PPS_Signal> _value) {}
	virtual void handle(std::shared_ptr<const ::vehicle::UBX_Packet> _value, std::shared_ptr<const ::vnx::Sample> _sample) { handle(_value); }
	virtual void handle(std::shared_ptr<const ::vehicle::UBX_Packet> _value) {}
...
#endif // INCLUDE_vehicle_UbloxReceiverBase_HXX_
