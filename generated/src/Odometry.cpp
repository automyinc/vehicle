...
const vnx::Hash64 Odometry::VNX_TYPE_HASH(0xd17d2d2984295c5aull);
const vnx::Hash64 Odometry::VNX_CODE_HASH(0x211cfcb66939b528ull);
...
const vnx::TypeCode* Odometry::get_type_code() {
	const vnx::TypeCode* type_code = vnx::get_type_code(vnx::Hash64(0xd17d2d2984295c5aull));
	if(!type_code) {
...
std::shared_ptr<vnx::TypeCode> Odometry::create_type_code() {
	...
	type_code->name = "vehicle.Odometry";
	type_code->type_hash = vnx::Hash64(0xd17d2d2984295c5aull);
	type_code->code_hash = vnx::Hash64(0x211cfcb66939b528ull);
...
void write(TypeOutput& out, const ::vehicle::Odometry& value, const TypeCode* type_code, const uint16_t* code) {
	if(!type_code || (code && code[0] == CODE_ANY)) {
		type_code = vnx::write_type_code<::vehicle::Odometry>(out);
		vnx::write_class_header<::vehicle::Odometry>(out);
	}
